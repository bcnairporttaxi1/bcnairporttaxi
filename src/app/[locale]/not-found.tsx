...
export default async function LocaleNotFound() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-28 text-center">
      <p className="font-mono text-6xl font-bold text-accent-deep">404</p>
      ...
      <Link
        href="/"
        className="mt-8 rounded-lg bg-accent px-5 py-3 font-display font-extrabold text-ink hover:bg-accent-deep"
      >
        {t('cta')}
      </Link>
    </div>

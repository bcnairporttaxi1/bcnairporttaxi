      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <ul className="mt-4 space-y-2 text-sm">
            {routes.map((p) => (
              <li key={p.slug}>
                ...
                <Link prefetch={false} href={`/${p.slug}`} className="hover:text-gold">
        ...
        <nav aria-labelledby="footer-company">
          ...
          <ul className="mt-4 space-y-2 text-sm">
            {COMPANY_LINKS.map((l) => (
              <li key={l.href}>
                <Link prefetch={false} href={l.href} className="hover:text-gold">
            ...
            <li>
              <Link prefetch={false} href="/install" className="hover:text-gold">
                {t('installApp')}
              </Link>
            </li>
          </ul>
